...
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("11 inch.", 100.05, "Display", "../images/part3_4/11.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("13 inch.", 150.33, "Display", "../images/part3_4/13.png", 1);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("15 inch.", 200.99, "Display", "../images/part3_4/15.png", 0);

INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("HDD 256GB", 39.95, "Drive", "../images/part3_4/hdd256.png", 0);
...
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("HDD 750GB", 58.99, "Drive", "../images/part3_4/hdd750.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("SSD 128GB", 68.75, "Drive", "../images/part3_4/ssd128.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("SSD 256GB", 109.32, "Drive", "../images/part3_4/ssd256.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("SSD 500GB", 179.99, "Drive", "../images/part3_4/ssd500.png", 0);

INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("4GB", 29.95, "Ram", "../images/part3_4/ram4.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("8GB", 83.02, "Ram", "../images/part3_4/ram8.png",1);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("16GB", 129.10, "Ram", "../images/part3_4/ram16.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("32GB", 300.75, "Ram", "../images/part3_4/ram32.png", 0);

INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("Intel i3", 101.99, "Cpu", "../images/part3_4/i3.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("Intel i5", 179.25, "Cpu", "../images/part3_4/i5.png",1);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("Intel i7", 253.97, "Cpu", "../images/part3_4/i7.png", 0);

INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("Windows 7", 18.99, "Os", "../images/part3_4/win7.png",1);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("Windows 10", 45.70, "Os", "../images/part3_4/win10.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("Mac High Sierra", 50.98, "Os", "../images/part3_4/macsierra.png", 0);
INSERT INTO components (Name, Price, ComponentType, ImageUrl, IsDefault) VALUES("Ubuntu 17.10", 10.65, "Os", "../images/part3_4/ubuntu.png", 0);
