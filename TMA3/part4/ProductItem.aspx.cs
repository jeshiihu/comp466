...
public partial class part3_ProductItem : System.Web.UI.Page
{
    ...
    protected void ConfigureComponents()
    {
        ...
        var components = Dal.GetAllComponents();
    ...
    private Component GetComputer()
    {
        ...
        return Dal.GetComputer(Int32.Parse(compId));
    }
    ...
    protected void btnAddToCart_Click(object sender, EventArgs e)
    {
        ...
        {
            Dal.GetComponent(Int32.Parse(optDisplay.SelectedItem.Value)),
            Dal.GetComponent(Int32.Parse(optDrive.SelectedItem.Value)),
            Dal.GetComponent(Int32.Parse(optRam.SelectedItem.Value)),
            Dal.GetComponent(Int32.Parse(optCpu.SelectedItem.Value)),
            Dal.GetComponent(Int32.Parse(optOs.SelectedItem.Value))
        };
    ...
    private void AddCartItem(CartItem item)
    {
        ...
        if (IsUserLoggedIn)
        {
            item.TableRowId = Dal.AddCartItemToOrder(item, loginSignUp.Text);
    ...
    private double ParseDropDownListForPrice(DropDownList dropdown)
    {
        ...
        var item = Dal.GetComponent(Int32.Parse(itemId));
